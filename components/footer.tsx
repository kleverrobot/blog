...
const Footer = () => {
  return (
    <footer className="bg-babyblue bg-opacity-50 border-t border-babyblue">
      <Container>
        <div className="py-8 flex flex-col items-center align-middle text-space-dark">
          ...
          <h4 className="mt-4 p-2 text-space font-light rounded-xl text-center">This site was made by me using next.js, tailwind and typescript</h4>
        </div>
      </Container>
    </footer>
  );
